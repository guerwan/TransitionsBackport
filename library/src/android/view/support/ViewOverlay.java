...
public class ViewOverlay {
     ...
     * @return
     */
    OverlayViewGroup getOverlayView() {
    ...
    static class OverlayViewGroup extends ViewGroup {
        ...
        OverlayViewGroup(Context context, View hostView) {
            ...
            Object attachInfoHostView = null;
            try{
                Field field = ViewGroup
                        .class.getField("mAttachInfo");
                attachInfoHostView = field.get(mHostView);
                field.set(this, attachInfoHostView);
            }
            catch(Exception e)
            {
            }
        ...
        public void add(View child) {
            if (child.getParent() instanceof ViewGroup) {
                ...
                if (parent.getLayoutTransition() != null) {
                    try{
                        Method method = LayoutTransition
                                .class.getMethod("cancel", int.class);
                        method.invoke(parent.getLayoutTransition(), LayoutTransition.DISAPPEARING);
                    }
                    catch(Exception e)
                    {
                    }
...
//            super.invalidateViewProperty(invalidateParent, forceRedraw);
            if (mHostView != null) {
                try{
                    Method method = View.class.getMethod("invalidateViewProperty", boolean.class, boolean.class);
                    method.invoke(mHostView, invalidateParent, forceRedraw);
                }
                catch(Exception e)
                {
                }
...
//            super.invalidateParentCaches();
            if (mHostView != null) {
                try{
                    Method method = View.class.getMethod("invalidateParentCaches");
                    method.invoke(mHostView);
                }
                catch(Exception e)
                {
                }
...
//            super.invalidateParentIfNeeded();
        ...
        public void invalidateChildFast(View child, final Rect dirty) {
            if (mHostView != null) {
                ...
                if (!child.getMatrix().isIdentity()) {
                    try{
                        Method method = View.class.getMethod("transformRect", Rect.class);
                        method.invoke(child, dirty);
                    }
                    catch(Exception e)
                    {
                    }
        ...
        protected ViewParent invalidateChildInParentFast(int left, int top, Rect dirty) {
            if (mHostView instanceof ViewGroup) {
                try{
                    Method method = ViewGroup.class.getMethod("invalidateChildInParentFast", int.class, int.class, Rect.class);
                    return (ViewParent)method.invoke(((ViewGroup) mHostView), left, top, dirty);
                }
                catch(Exception e)
                {
                }
