 ...
 */
public class ViewGroupOverlay extends android.view.support.ViewOverlay {
     ...
     * @see #remove(android.view.View)
     * @see ViewOverlay#add(android.graphics.drawable.Drawable)
     */
     ...
     * @see ViewOverlay#remove(android.graphics.drawable.Drawable)
     */
